...
class Market1501Dataset(object):
    ...
    def __init__(self, root='data', **kwargs):
        ...
        self.pose_train_dir = osp.join(self.pose_dataset_dir, 'bounding_box_train')
        self.pose_query_dir = osp.join(self.pose_dataset_dir, 'query')
        self.pose_gallery_dir = osp.join(self.pose_dataset_dir, 'bounding_box_test')
        ...
        gallery, num_gallery_pids, num_gallery_imgs = self._process_dir(self.gallery_dir,self.pose_gallery_dir, relabel=False)
    ...
    def _process_dir(self, dir_path,pose_dir_path,relabel=False):
