...
class ReIDLoss(nn.Module):
    ...
    def __init__(self, 
                 model_path_ = '/unsullied/sharefs/zhongyunshan/isilon-home/model-parameters/DeepFashion-correct-background/model_best.pth.tar', 
                 size=(256, 128), 
                 gpu_ids=None,
                 is_trainable=False,
                 w = [1,1,1,1]):
        ...
        model, optim_policy = get_baseline_model(num_classes=5837, eval_norm=0, model_path=None)
